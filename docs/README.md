...
|2021年7月|エス・エー・エス株式会社　入社|

## 職務要約

* **エス・エー・エス株式会社**（2021年7月 - 現在）
  * 資本金：5,000万円
  * 従業員数：130名
  * 設立：1995年10月
  * 事業内容：
...
* **田中商事株式会社**（2014年4月 - 2015年9月）
  ...
  * 事業内容：電気材料及び電気器具の卸売、電設機材、照明、OA・住設機器などの総合卸販売
  ...
  [^1][テラハウスＩＣＡキャリア開発研究所](https://www.terahouse-ica.ac.jp/)
---

## 職務経歴

### クラウド移行
* **概要**: オンプレミス上のシステムをクラウド（ニフクラ）上に移行
...
* **課題**
  * 以下のような課題点があり、このプロジェクトに至りました
    * WindowsServer2012からWindowsServer2019へのシステム移行であり、既存環境とミドルウェアのバージョン等が異なっている
* **実績・成果**
...
* **工夫した点**
  * ほぼフルリモート上で参画した案件であったので、チャットツール（Teams）を用いて、顧客とコミュニケーションをうまく図るようにした。
---
### 動画配信システム内製化
...
|OS|Windows、Mac|
|言語|Visual Basic.NET、C#、HTML、CSS、JavaScript、TypeScript[^2]|
|フレームワーク|jQuery、Bootstrap、Node.js、[^2]Next.js[^2]、Nuxt.js[^2]、React[^2]、Vue.js[^2]|
|DB|SQLServer（4年）、MySQL（半年）、SQLite（半年）|
|その他|Git（5年）、Adobe Xd（半年）、Docker[^2]|
|Iaas|AWS[^2]、GitHub Actions[^2]|
