...
|OS|Windows、Mac|
|言語|Visual Basic.NET、C#、Java、HTML、CSS、JavaScript、TypeScript[^2]|
|フレームワーク|Spring Framework、Apache Struts 2、jQuery、Bootstrap、Node.js、[^2]Next.js[^2]、Nuxt.js[^2]、React[^2]、Vue.js[^2]|
...
|2010年3月|普通自動二輪車免許|
|2016年7月|ITパスポート|
|2021年8月|Microsoft Azure Fundamentals|
